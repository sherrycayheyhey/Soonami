...
public class MainActivity extends AppCompatActivity {
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            //if the URL is null then get the heck out of here!
            if(url == null) {
                //return a jsonResponse that contains an empty string
                return jsonResponse;
            }
            ...
            try {
                ...
                //Step 2. establish the http connection
                urlConnection.connect();

                //Step 3. receive the response and make sense of it
                //check the server response code, 200 means it was successful
                //if it's all good, read the input stream and parse the response
        ...
        */
        ...
        private Event extractFeatureFromJson(String earthquakeJSON) {
            //if the JSON string is empty or null, get the heck out of here (the HTTP request didn't go so good)
